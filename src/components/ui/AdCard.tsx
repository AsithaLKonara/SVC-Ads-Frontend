...
export default function AdCard({
  ...
  return (
    <Link href={`/ad/${id}`} className="group block h-full">
      <div className="relative flex h-full flex-col overflow-hidden rounded-2xl bg-card shadow-premium transition-all duration-300 hover:-translate-y-1 hover:shadow-premium-hover border border-border/50">
        {/* Image Container */}
        ...
        <div className="flex flex-1 flex-col p-4">
          ...
          <h3 className="mb-2 line-clamp-2 font-heading text-base font-semibold text-card-foreground group-hover:text-brand-600 transition-colors">
            {title}
          </h3>
          
          <div className="mt-auto">
            <div className="mb-3 text-lg font-bold text-brand-600">
              Rs {price}
            </div>
